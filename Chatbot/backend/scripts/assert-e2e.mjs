...
const client = await prisma.client.findFirst({ where: { platform: 'website', platformUserId: 'agent_flow_1' } });
...
console.log(JSON.stringify({
  client: client ? { id: client.id, fullName: client.fullName, phone: client.phone, language: client.language } : null,
