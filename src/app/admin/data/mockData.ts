...
export const mockBiens: Bien[] = [
  {
    ...
    description: 'Magnifique villa moderne à 5min de la plage. Cette somptueuse villa offre un cadre de vie exceptionnel avec ses 4 chambres spacieuses, sa piscine privée et son jardin paysager.',
    type: 'villa',
    nb_chambres: 4,
    nb_salle_bain: 3,
    prix_nuitee: 450,
  ...
  },
  {
    ...
    description: 'Vue imprenable sur la Méditerranée. Appartement moderne et lumineux avec balcon offrant une vue panoramique exceptionnelle.',
    type: 'S2',
    nb_chambres: 2,
    nb_salle_bain: 1,
    prix_nuitee: 120,
  ...
  },
  {
    ...
    description: 'Idéal étudiant ou jeune couple. Studio fonctionnel en plein centre-ville, proche de toutes commodités.',
    type: 'studio',
    nb_chambres: 1,
    nb_salle_bain: 1,
    prix_nuitee: 60,
  ...
  },
  {
    ...
    description: 'Grand local sur rue passante. Excellent emplacement pour votre commerce avec forte visibilité et passage.',
    type: 'local',
    nb_chambres: 0,
    nb_salle_bain: 1,
    prix_nuitee: 250,
...
export const mockContrats: Contrat[] = [
  { 
    ...
    date_fin: '2024-04-30', 
    montant_recu: 2400,
    url_pdf: '/contracts/contract-001.pdf',
    statut: 'actif', 
