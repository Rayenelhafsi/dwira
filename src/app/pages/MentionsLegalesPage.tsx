...
const MENTIONS_PDF_PATH = "/legal/Mentions_legales_Dwira_Immobilier.pdf";
      ...
      <div className="mx-auto max-w-6xl">
        <div className="mb-6 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <h1 className="text-3xl font-bold text-slate-900 md:text-4xl">Mentions Legales</h1>
          </div>
          <a
            href={MENTIONS_PDF_PATH}
            target="_blank"
            rel="noreferrer"
        ...
        <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
          <iframe
            title="Mentions Legales Dwira Immobilier"
            src={MENTIONS_PDF_PATH}
