        ...
        {!loadingResults && results.length > 0 && (
          <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
            {results.map((hotel) => {
              ...
              return (
                <article key={hotel.Id} className="group overflow-hidden rounded-[30px] border border-slate-100 bg-white shadow-[0_18px_48px_rgba(15,23,42,0.08)] transition hover:-translate-y-1 hover:shadow-[0_28px_60px_rgba(15,23,42,0.12)]">
                    ...
                    <div className="relative aspect-[16/10] overflow-hidden">
                      ...
                      {minPrice !== null && (
                        <div className="absolute bottom-4 right-4 rounded-2xl bg-white px-3 py-2 text-right text-sm font-semibold text-slate-900 shadow-md">
                          A partir de {formatPrice(minPrice)} TND
                        </div>
                      )}
                    </div>
                  </Link>
