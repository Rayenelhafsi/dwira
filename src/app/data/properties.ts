...
export interface Property {
  ...
  modalite_paiement_vente?: string | null;
  ...
  terrain_disponibilite_reseaux?: string[];
  terrain_forme?: string | null;
  terrain_topographie?: string | null;
  terrain_bornage?: boolean;
  terrain_type_sol?: string | null;
  terrain_vegetation?: string | null;
  terrain_niveau_sonore?: string | null;
  terrain_exposition_vent?: string | null;
  terrain_ideal_utilisations?: string[];
  terrain_documents_disponibles?: string[];
