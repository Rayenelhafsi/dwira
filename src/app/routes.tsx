...
export const router = createBrowserRouter([
  ...
  },
  {
    ...
    children: [
      ...
      { path: "cgv", lazy: lazyPage(() => import("./pages/CgvPage")) },
      ...
      { path: "partner-agency/login", lazy: lazyPage(() => import("./pages/PartnerAgencyLoginPage")) },
      { path: "partner-agency/dashboard", lazy: lazyPage(() => import("./pages/PartnerAgencyDashboardPage")) },
      { path: ":amicaleSlug/:propertyRef", lazy: lazyPage(() => import("./pages/AmicalePropertyRedirectPage")) },
      { path: ":amicaleSlug", lazy: lazyPage(() => import("./pages/AmicaleLandingPage")) },
...

  {
    ...
    children: [
      ...
      { path: "agences-partenaires", lazy: lazyPage(() => import("./admin/pages/PartnerAgenciesPage")) },
      ...
      { path: "comptabilite", lazy: lazyPage(() => import("./admin/pages/ComptabilitePage")) },
      { path: "ventes", lazy: lazyPage(() => import("./admin/pages/VentesAdminPage")) },
      { path: "hotels", lazy: lazyPage(() => import("./admin/pages/HotelsPage")) },
