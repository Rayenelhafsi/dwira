...
function dbRowToBien(row: any, media: any[] = [], unavailableDates: any[] = []): Bien {
  ...
  return {
    ...
    reservation_sur_demande: row.reservation_sur_demande === 1 || row.reservation_sur_demande === true || row.reservation_sur_demande === '1',
...
function bienToProperty(
  ...
  return {
    ...
    status: bien.statut,
    statut: bien.statut,
    prix_affiche_client: bien.prix_affiche_client ?? null,
    prix_final: bien.prix_final ?? null,
    modalite_paiement_vente: bien.modalite_paiement_vente ?? null,
    pourcentage_premiere_partie_promesse: bien.pourcentage_premiere_partie_promesse ?? null,
    montant_premiere_partie_promesse: bien.montant_premiere_partie_promesse ?? null,
    montant_deuxieme_partie: bien.montant_deuxieme_partie ?? null,
    nombre_tranches: bien.nombre_tranches ?? null,
    periode_tranches_mois: bien.periode_tranches_mois ?? null,
    montant_par_tranche: bien.montant_par_tranche ?? null,
    type_papier: bien.type_papier ?? null,
    type_rue: bien.type_rue ?? null,
    superficie_m2: bien.superficie_m2 ?? null,
    etage: bien.etage ?? null,
    configuration: bien.configuration ?? null,
    annee_construction: bien.annee_construction ?? null,
    distance_plage_m: bien.distance_plage_m ?? null,
    surface_local_m2: bien.surface_local_m2 ?? null,
    facade_m: bien.facade_m ?? null,
    hauteur_plafond_m: bien.hauteur_plafond_m ?? null,
    activite_recommandee: bien.activite_recommandee ?? null,
    toilette: bien.toilette ?? false,
    reserve_local: bien.reserve_local ?? false,
    vitrine: bien.vitrine ?? false,
    coin_angle: bien.coin_angle ?? false,
    electricite_3_phases: bien.electricite_3_phases ?? false,
    alarme: bien.alarme ?? false,
    type_terrain: bien.type_terrain ?? null,
    terrain_facade_m: bien.terrain_facade_m ?? null,
    terrain_surface_m2: bien.terrain_surface_m2 ?? null,
    terrain_distance_plage_m: bien.terrain_distance_plage_m ?? null,
    terrain_zone: bien.terrain_zone ?? null,
    terrain_constructible: bien.terrain_constructible ?? false,
    terrain_angle: bien.terrain_angle ?? false,
    terrain_prix_affiche_total: bien.terrain_prix_affiche_total ?? null,
    terrain_prix_affiche_par_m2: bien.terrain_prix_affiche_par_m2 ?? null,
    terrain_disponibilite_reseaux: Array.isArray(bien.terrain_disponibilite_reseaux) ? bien.terrain_disponibilite_reseaux : [],
    terrain_forme: bien.terrain_forme ?? null,
    terrain_topographie: bien.terrain_topographie ?? null,
    terrain_bornage: bien.terrain_bornage ?? false,
    terrain_type_sol: bien.terrain_type_sol ?? null,
    terrain_vegetation: bien.terrain_vegetation ?? null,
    terrain_niveau_sonore: bien.terrain_niveau_sonore ?? null,
    terrain_exposition_vent: bien.terrain_exposition_vent ?? null,
    terrain_ideal_utilisations: Array.isArray(bien.terrain_ideal_utilisations) ? bien.terrain_ideal_utilisations : [],
    terrain_documents_disponibles: Array.isArray(bien.terrain_documents_disponibles) ? bien.terrain_documents_disponibles : [],
    immeuble_surface_terrain_m2: bien.immeuble_surface_terrain_m2 ?? null,
    immeuble_surface_batie_m2: bien.immeuble_surface_batie_m2 ?? null,
    immeuble_nb_niveaux: bien.immeuble_nb_niveaux ?? null,
    immeuble_nb_garages: bien.immeuble_nb_garages ?? null,
    immeuble_nb_appartements: bien.immeuble_nb_appartements ?? null,
    immeuble_nb_locaux_commerciaux: bien.immeuble_nb_locaux_commerciaux ?? null,
    immeuble_distance_plage_m: bien.immeuble_distance_plage_m ?? null,
    immeuble_ascenseur: bien.immeuble_ascenseur ?? false,
    immeuble_parking_sous_sol: bien.immeuble_parking_sous_sol ?? false,
    immeuble_parking_exterieur: bien.immeuble_parking_exterieur ?? false,
    immeuble_syndic: bien.immeuble_syndic ?? false,
    immeuble_vue_mer: bien.immeuble_vue_mer ?? false,
    lotissement_nb_terrains: bien.lotissement_nb_terrains ?? null,
    lotissement_prix_total: bien.lotissement_prix_total ?? null,
  ...
  const fetchData = async (options?: { silent?: boolean }) => {
    ...
    try {
      ...
      const localBiens: Bien[] = localProperties.map((p: Property) => ({
        ...
        reference: p.id,
        titre: p.title,
        nom_bien_mobile: p.title,
        nom_application: p.title,
        ...
        reservation_sur_demande: !!p.reservationOnRequest,
        ui_config: null,
